...
/// (usando dsp::interpolateSample con interpolación cúbica
/// directamente, no dsp::Resampler — ver nota de diseño en
/// dsp/resampler.hpp), aplica envolvente ADSR (dsp::Envelope) con
/// parámetros por defecto fijos, respeta looping simple (forward)
/// cuando `SampleSource::loopEnabled`, y aplica opcionalmente un
/// filtro biquad por voz (dsp::Filter, ver `setFilterCutoff`) usando
/// un buffer interno de scratch pre-asignado (sin allocación en
/// `renderBlock`).
///
