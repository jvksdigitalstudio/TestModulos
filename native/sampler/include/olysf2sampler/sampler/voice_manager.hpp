...
public:
    ...
    /// Aplica una calidad de interpolación de pitch a TODAS las voces
    /// del pool (activas e inactivas — las inactivas la heredan cuando
    /// se disparen). Mismo contrato de threading que `setFilterCutoff`.
